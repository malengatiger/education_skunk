...
public class TableUtil extends TableRenderer {
    ...
    private final List<List<String>> extractedData = new ArrayList<>();

    public TableUtil(Table modelElement) {
        super(modelElement);
    }
...
//    public static List<TableData> extractTableData(Table table, PdfDocument pdfDoc) {
//        TableUtil tableUtil = new TableUtil(table);
//        tableUtil.layout(new LayoutContext(pdfDoc, new Rectangle(0, 0, 0, 0)));
//        List<List<String>> extractedData = tableUtil.getExtractedData();
//
//        List<TableData> tableDataList = new ArrayList<>();
//        for (List<String> rowData : extractedData) {
//            tableDataList.add(new TableData(rowData));
//        }
//
